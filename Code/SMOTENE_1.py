...
# Import the data
data = pd.read_csv('F:\BUET\Data Mining\Assignment 1\Dataset\creditcardmf2.csv')
data.head()
...
data = data.drop(['Time','Amount'],axis = 1,inplace=False)


#Time Amount
df_example = data[['V1', 'V2', 'Class']]
#sns.scatterplot(data = df_example, x ='V1', y = 'V2', hue = 'Class')
