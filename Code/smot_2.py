...
X_train, X_test, y_train, y_test = train_test_split(df_example[['CreditScore', 'Age']], data['Exited'], test_size = 0.2, stratify = data['Exited'], random_state = 101)
...
df_oversampler_X = pd.DataFrame(X_oversample, columns = ['CreditScore', 'Age'])
#data['Exited']
